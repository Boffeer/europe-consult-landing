	...
	<div class="container header__container">
		...
		<?php else : ?>
			<div class="header-language">
				...
				<a href="<?php echo '//' . $_SERVER['HTTP_HOST'] . '/pages/fr/' . $index_page; ?>" class="header-language__switcher">fr</a>
				<p class="header-language__switcher  header-language__switcher--current">ru</p>
			</div>
		<?php endif; ?>
	</div>
</header>
