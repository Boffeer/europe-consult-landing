<section class="lead">
	...
	<div class="container lead__container">
		<h2 class="section__title lead__title">
			Не упустите шанс записаться&nbsp;на бесплатную консультацию и
			узнатькак получать от 3-10 клиентов в день из Instagram и Google
			по минимальной цене
		</h2>
		...
		<p class="section__caption lead__caption">
			<span class="lead__caption-text--highlight lead__caption-text">
				<span class="section__text--color">Запись консультации</span>
